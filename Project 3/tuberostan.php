...
<?php
    ...
    {
    $antal = $row['antalvitsord'];
    $summaf1 = $antal * $row['vitsord'];
    $antal = $antal + 1;
    $nysummaf1 = $summaf1 + $f1;
    $mf1 = $nysummaf1/$antal;
    }        
    $result = $mysqli->query("UPDATE tube2015
    SET antalvitsord=$antal, vitsord=$mf1
    WHERE id=$idn;");
    print("<p>Medeltal: $mf1<br/>");
    print("<p>Antal givna: $antal</p>");
    }
?>
<br>
