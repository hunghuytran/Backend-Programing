...
$idn = $_GET['varuidn'];
$result = $mysqli->query("DELETE FROM varukorg2015 WHERE id='$idn';");
if ($mysqli->error) {print("<p>Sökning kunde inte utföras.<br/>Fel: ".$mysqli->error."</p>");}
 print("<br/><form action='butikkorg.php? method='post'><input type ='submit' value='Radera'/></form>");
