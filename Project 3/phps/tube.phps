...
Välj en bild som du vill ladda upp:
<input type="file" name="filnamn" id="filnamn">
<br/><input type="submit" value="Ladda upp bilden" name="submit">
</form>
<?php
...
$result = $mysqli->query("SELECT * FROM tube2015 ORDER BY visningar DESC;");
