...
$result = $mysqli->query("SELECT * FROM varor2015 ;");
...
if ($result->num_rows == 0) 
    ...
    $prodnamn = $row['namn'];
    $prodpris = $row['pris'];
    $_SESSION['bestallare'] = 'Johnny';    
      print("<p>Produkt: ".$row['namn']."<br/>");
      print("Beskrivning: ".$row['beskrivning']."<br/>");
      print("Pris: ".$row['pris']."<br/>");
      print("Antal: ".$row['antal']."<br/>");
    print("<a href='butikkop.php?varuidn=$varuid&pnamn=$prodnamn&ppris=$prodpris'>Köp</a></p>");
    }
    }
$mysqli->close();
?>
