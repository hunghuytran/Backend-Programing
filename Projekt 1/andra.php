...
$result = $mysqli->query("SELECT * FROM produkter2015 WHERE forsaljare='$anv';");
...
if ($result->num_rows == 0) 
    ...
    $idn = $row['id'];
    print("<td><form action='andrapost.php?id=$idn' method='post'><input type ='submit' value='ändra'/></form></td>");
      print("</tr>");
      }
    print("</table>"); 
    }
