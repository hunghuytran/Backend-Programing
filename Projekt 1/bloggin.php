...
if (isset($_REQUEST['blogg']))
    ...
    if ($mysqli->affected_rows == 0) 
        ...
        {
        print("<p>Inmatning gjord. <a href='bloggin.php'>Mata in flera?</a></p>");
        }
    $mysqli->close();
    }
else
    ...
    print("Taggar: <input type='text' name='taggar' size='10'><br/>");
    print("Kategori: <input type='text' name='kat' size='20'><br/>");
