...
{
print("<form action='sok.php' method='get'>Sökord: <input type='text' name='sokord'>");
print("<input type='submit' value='Sök'></form>");
$sok = $_REQUEST['sokord'];
include('dbaccess.php');
$mysqli = new mysqli($dbhost,$dbusername,$dbpassword,$dbname);
$mysqli->set_charset('utf8');
if ($mysqli->connect_error) {print("<p>Koppling till sql-server misslyckades. Felkod: ".$mysqli->connect_error."</p>");} 
$result = $mysqli->query("SELECT * FROM produkter2015 WHERE produkt LIKE '%$sok%' OR beskrivning LIKE '%$sok%';");
