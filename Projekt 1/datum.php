...
<a href="https://cgi.arcada.fi/~tranhung/BE2015/datum.phps">PHPS-filen</a>
<br/>
<form action="datum2.php" method="get"> 
Dag: <input type="text" name="dd" size="6"><br/>
Månad: <input type="text" name="mm" size="3.9"><br/>
År: <input type="text" name="aaaa" size="8"></p>
