...
$idn = $_REQUEST['id'];
$result = $mysqli->query("SELECT * FROM anvandare2015 WHERE id='$idn';");
...
if ($result->num_rows == 0) 
	...
	$role = $row['role'];
    $status = $row['status'];
    print("<p><form action='andranya.php?id=$idn' method='post'>");
    print("Username: <br/><input type='text' name='user' size='40' value='$user'><br/>");
    print("Password: <br/><input type='text' name='password' size='60' value='$password'><br/>");
    print("Email: <br/><input type='text' name='email' size='10' value='$email'><br/>");
    print("Registered: <br/><input type='text' name='registered' size='10' value='$registered'><br/>");
	print("Role: <br/><input type='text' name='role' size='10' value='$role'><br/>");
    print("Status: <br/><input type='text' name='status' size='10' value='$status'><br/>");
